...
class LlavaVlmFastImageProcessorKwargs(DefaultFastImageProcessorKwargs):
...
class LlavaVlmImageProcessorFast(BaseImageProcessorFast):
    ...
    do_normalize = True
    do_convert_rgb = True
    valid_kwargs = LlavaVlmFastImageProcessorKwargs

    def __init__(self, **kwargs: Unpack[LlavaVlmFastImageProcessorKwargs]) -> None:
    ...
    def preprocess(self, images: ImageInput, **kwargs: Unpack[LlavaVlmFastImageProcessorKwargs]) -> BatchFeature:
...
defualt_llava_vlm_image_processor_config = {
    "crop_size": {
        "height": 336,
        "width": 336
    },
...
AutoImageProcessor.register(LlavaVlmConfig, fast_image_processor_class=LlavaVlmImageProcessorFast)
