...
from .image_processing_llava_vlm import LlavaVlmImageProcessorFast


logger = logging.get_logger(__name__)


class LlavaVlmProcessorKwargs(ProcessingKwargs, total=False):
...
class LlavaVlmProcessor(ProcessorMixin):
    ...
    image_processor_class = "LlavaVlmImageProcessorFast"
    ...
    def __call__(
        ...
        audio=None,
        videos=None,
        **kwargs: Unpack[LlavaVlmProcessorKwargs],
    ) -> BatchFeature:
        """
