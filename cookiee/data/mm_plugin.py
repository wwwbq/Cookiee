...
class LlavaPlugin(BasePlugin):
    def preprocess_multi_modal_messages(
        ...
        if images is not None and len(images) != num_image_tokens:
...
class Qwen2vlPlugin(BasePlugin):
    ...
    def preprocess_multi_modal_messages(
        ...
        for message in messages:
            ...
            while self.video_placeholder in content and len(videos) > 0:
        ...
        if images is not None and len(videos) != num_video_tokens:
